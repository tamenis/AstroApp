...
class oe extends q {
  ...
  loader
  constructor(t, n, o, r, a, l, f, i, m) {
    super(Q, { cancelable: !0 }, t, n, o, r, a, l, f),
      (this.formData = i),
...
async function ie(e, t, n, o, r, a, l, f) {
  const i = new oe(e, t, n, o, r, a, window.document, l, f)
  return (
    document.dispatchEvent(i) &&
      (await i.loader(),
      i.defaultPrevented ||
        (ne(Z), i.navigationType !== 'traverse' && x({ scrollX, scrollY }))),
    i
  )
}
...
const j = (e, t, n, o, r) => {
  ...
  if (e.href !== location.href && !r)
    ...
    } else ae({ ...n.state, index: ++T, scrollX: 0, scrollY: 0 }, '', e.href)
  if (
    ((L = e),
    ...
    if (e.hash) {
      ...
      const i = history.state
      ;(location.href = e.href), history.state || v(i, '')
  ...
  for (const n of e.querySelectorAll('head link[rel=stylesheet]'))
    if (
      !document.querySelector(
        `[${w}="${n.getAttribute(w)}"], link[rel=stylesheet][href="${n.getAttribute('href')}"]`
      )
    ) {
...
async function M(e, t, n, o) {
  const r = (s, d) => {
      ...
      if (s.matches('link[rel=stylesheet]')) {
        ...
        return d.head.querySelector(`link[rel=stylesheet][href="${b}"]`)
      }
      return null
    },
    a = () => {
      ...
      if (s?.closest(`[${w}]`)) {
        if (s instanceof HTMLInputElement || s instanceof HTMLTextAreaElement) {
          const d = s.selectionStart,
            h = s.selectionEnd
          return { activeElement: s, start: d, end: h }
        }
        return { activeElement: s }
      } else return { activeElement: null }
    },
    l = ({ activeElement: s, start: d, end: h }) => {
      s &&
        (s.focus(),
        (s instanceof HTMLInputElement || s instanceof HTMLTextAreaElement) &&
          ((s.selectionStart = d), (s.selectionEnd = h)))
    },
    f = (s) => {
      const d = document.documentElement,
        h = [...d.attributes].filter(
      ...
      for (const c of g.querySelectorAll(`[${w}]`)) {
        const u = c.getAttribute(w),
          R = document.querySelector(`[${w}="${u}"]`)
        R && R.replaceWith(c)
      }
      l(b)
    }
  async function i(s) {
    ...
    const b = document.getAnimations().filter((c) => !h.includes(c) && !d(c))
    return Promise.all(b.map((c) => c.finished))
  }
  if (!A)
...
async function K(e, t, n, o, r) {
  ...
  if (
    (a !== 'traverse' && x({ scrollX, scrollY }),
    C(t, n) && ((e !== 'back' && n.hash) || (e === 'back' && t.hash)))
  ) {
    j(n, t, o, document.title, r)
    return
  }
  const l = await ie(t, n, e, a, o.sourceElement, o.info, o.formData, f)
  ...
  async function f(i) {
    ...
    if (i.formData) {
      ...
      y.body =
        h?.attributes.getNamedItem('enctype')?.value ===
  ...
  if (((A = !1), P))
    p = document.startViewTransition(async () => await M(l, o, r))
  else {
    const i = (async () => {
      await new Promise((m) => setTimeout(m)), await M(l, o, r, Y())
    })()
    p = {
...
async function N(e, t) {
  await K('forward', L, new URL(e, location.href), t ?? {})
}
function me(e) {
  if (!I() && e.state) {
    location.reload()
  ...
  const t = history.state,
    n = t.index,
    o = n > T ? 'forward' : 'back'
  ;(T = n), K(o, L, new URL(location.href), {}, t)
}
const F = () => {
  x({ scrollX, scrollY })
}
{
  ;(P || Y() !== 'none') &&
    ...
    'onscrollend' in window
      ...
      : addEventListener('scroll', le(F, 350), { passive: !0 }))
...
function we() {
  for (const e of ['touchstart', 'mousedown'])
    document.body.addEventListener(
      ...
      (t) => {
        E(t.target, 'tap') &&
          D(t.target.href, { with: 'fetch', ignoreSlowConnection: !0 })
      },
      { passive: !0 }
    )
}
...
function pe() {
  ...
  O(() => {
    for (const t of document.getElementsByTagName('a'))
      S.has(t) || (E(t, 'viewport') && (S.add(t), (e ??= ge()), e.observe(t)))
  })
}
function ge() {
  const e = new WeakMap()
      ...
      o.isIntersecting
        ? (a && clearTimeout(a),
          e.set(
            r,
            setTimeout(() => {
              n.unobserve(r), e.delete(r), D(r.href, { with: 'link' })
            }, 300)
          ))
