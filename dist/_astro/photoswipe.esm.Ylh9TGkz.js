...
class k {
  ...
  _getSecondary() {
    ...
    return (
      ...
      this.elementSize &&
        t * this.elementSize.x > T &&
        (t = T / this.elementSize.x),
      t)
    )
  }
  _getInitial() {
...
class j {
  constructor(t, i, e) {
    ;(this.data = t),
      ...
      (this.zoomLevels = new k(e.options, t, i, e)),
...
class it {
  ...
  change() {
    ...
    if (
      ...
      this._panOrMoveMainScroll('x') ||
        ...
        s && (M(s.pan), s.applyCurrentZoomPan()))
  }
  end() {
  ...
  _finishPanGestureForAxis(t) {
    ...
    const { pan: s, bounds: n } = e,
      ...
      l = o + tt(i[t], h)
    if (a) {
      const v = this._getVerticalDragRatio(o),
...
class lt {
  ...
  _finishTap(t) {
    ...
    this._tapTimer
      ? (this._clearTapTimer(),
        A(this._lastStartP1, this.startP1) < ht &&
...
class dt {
  ...
  updateCurrItem() {
    ...
    Math.abs(this._containerShiftIndex) > 50 &&
      ...
      (i.currSlide =
        (t = this.itemHolders[1]) === null || t === void 0 ? void 0 : t.slide),
...
class ut {
  ...
  _onKeyDown(t) {
    const { pswp: i } = this
    if (i.dispatch('keydown', { originalEvent: t }).defaultPrevented || G(t))
      return
    let e,
      s,
      n = !1
    ...
    if (this._dampingRatio === 1)
      ...
      ;(e = n * (t * o + s * a)),
        (this.velocity =
          ...
          n * (-this._dampedFrequency * t * a + this._dampedFrequency * s * o))
    }
    return e
  }
}
...
class zt {
  ...
  registerElement(t) {
    this.isRegistered
      ? this.items.push(new xt(this.pswp, t))
  ...
  _onZoomPanUpdate() {
    ...
    const o =
      s === i.zoomLevels.initial ? i.zoomLevels.secondary : i.zoomLevels.initial
    D(t, o <= s),
...
function Zt(r, t, i) {
  const e = i.dispatch('thumbBounds', { index: r, itemData: t, instance: i })
  ...
  return (
    ...
    o &&
      (t.thumbCropped
        ? (n = Ot(o, t.width || t.w || 0, t.height || t.h || 0))
        : (n = Et(o))),
...
class Ft {
  ...
  activate() {
    this.instance.dispatch('contentActivate', { content: this })
      .defaultPrevented ||
      !this.slide ||
      (this.isImageContent() && this.isDecoding && !C()
        ? this.appendImage()
...
class Wt {
  ...
  _setClosedStateZoomPan(t) {
    ...
    if (
      ...
      const o = -n.x + (this._thumbBounds.x - e.x) + e.w,
...
class $t extends Ht {
  constructor(t) {
    super(),
      ...
      (this.contentLoader = new kt(this))
  }
  init() {
