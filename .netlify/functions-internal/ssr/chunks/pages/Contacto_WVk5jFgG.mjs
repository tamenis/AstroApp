...
const $$Contacto = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contacto" }, { "content": ($$result2) => renderTemplate`${renderComponent($$result2, "Formulario", Form, { "slot": "content", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/tamenis/Documents/Uned/AstroApp/src/components/Formulario.tsx", "client:component-export": "default" })}` })}`;
